<template>
  <q-toolbar class="card-header toolbar-round">
    <q-toolbar-title class="text-white">Задачи в плане</q-toolbar-title>
    <q-space/>
    <q-toolbar-title class="text-white" align="right">В ожидании: {{tasks.tasksPlaned.value.length}}</q-toolbar-title>
  </q-toolbar>
  ...
  <q-card  class="q-mt-sm q-pa-sm">
    <q-scroll-area
        ...
        style="height: 30vh"
    >
      <q-item  :style="{'backgroundColor':task.color}"  class="q-pa-xs" v-for="task in tasks.tasksPlaned.value" >
        ...
        <q-separator class="q-ml-sm q-mr-sm" vertical />
        <!--                  <q-item-section style="max-width: 30px" align="center">5</q-item-section>-->
        <q-separator class="q-ml-sm q-mr-sm" vertical />
