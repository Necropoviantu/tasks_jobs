<template>
  <q-toolbar class="card-header toolbar-round">
    <q-toolbar-title class="text-white">Задачи в работе</q-toolbar-title>
    <q-space/>
    <q-toolbar-title class="text-white" align="right">В работе: {{tasks.tasksAtWork.value.length}}</q-toolbar-title>
  </q-toolbar>
  <q-card  class=" q-mt-sm q-pa-none" >
    ...
    <q-scroll-area
        ...
        style="height: 33vh; "
    >
      <q-item :style="{'backgroundColor': colorTask(task.createdDate)}" class="q-pa-xs item-border " v-for="task in tasks.tasksAtWork.value" >
